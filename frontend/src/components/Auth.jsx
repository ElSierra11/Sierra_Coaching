...
export default function Auth({ onLogin, showToast, theme, toggleTheme }) {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between text-slate-900 dark:text-white bg-gymDark-950 pb-12 transition-colors duration-300">
      ...
      {/* dark-section = permanently dark bg → all text forced white in BOTH themes */}
      <section className="max-w-7xl mx-auto px-6 py-12 w-full">
        <div className="dark-section relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl bg-gradient-to-r from-neutral-900 via-black to-neutral-900 p-6 md:p-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
